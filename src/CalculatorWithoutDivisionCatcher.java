...
public class CalculatorWithoutDivisionCatcher {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalculatorWithoutDivisionCatcher window = new CalculatorWithoutDivisionCatcher();
	 ...
	 */
	public CalculatorWithoutDivisionCatcher() {
		firstNum = 0;
		secNum = 0;
		lastOp = "";
		afterEquals = false;
...
//			{
		...
		SquareRootButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ExpressionText.setText(ExpressionText.getText() + InputText.getText() + "SQ RT(" + InputText.getText() + ")");
		...
		ReciprocalButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					int reciprocating = 1/input2;
					String reciprocated = Integer.toString(reciprocating);
					InputText.setText(reciprocated);	
				}
			}
		});
		...
		EqualsButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(lastOp.equals("+"))
				{
					InputText.setText(Double.toString(secNum + firstNum));
